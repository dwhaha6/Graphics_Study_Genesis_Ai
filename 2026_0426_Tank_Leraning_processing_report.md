...
|-------|------|------|----------|----------|
| **0** | 1 NN vs 3 정지 dummy, 개활지, 자기장 X | 정지 | "타겟 지정 → 피해 → 보상" 인과 학습 | 100~200 |
| **1** | 1 NN vs 3 무작위 이동 dummy, 개활지 | 무작위 이동 (발사 X) | 움직이는 표적 추적 | 200~400 |
| **2** | **3 NN** vs 3 정지 dummy, 개활지 | 정지 | 다중 탱크 동시 제어 + 타겟 분담 | 300~500 |
| **3** | 3 NN vs 3 frozen Stage-2 NN, **엄폐물 8개** 활성 | 학습된 rusher (frozen) | 능동 교전 + 엄폐물 활용 | 500~1000 |
