...
![](./이미지/gudong.png)
3. 공기 저항 (Air Resistance): 자동차가 움직이는 속도에 비례해 바람의 저항을 받음
4. 마찰 저항 (Rolling Resistance): 바퀴가 지형 위를 굴러갈 때 발생하는 저항(울퉁불퉁한 길에서 저항이 더 커짐)
5. 중력 (Gravity Force): 자동차는 항상 아래로 잡아당겨짐
6. 수직 항력 (Normal Force): 중력으로 땅을 누르면, 땅이 자동차를 다시 위로 밀어내는 힘  
