...
![](./이미지/2026-06-23/Catmull-rom.png)
...
* 위처럼 특이한 경우(바로 앞이 장애물 + 제자리 90도 회전을 요구) spin때문에 경로 추종이 매우 오래 걸림
